...
class ColorfullBarChartModule(VisualizationElement):
    ...
    package_includes = ["d3.min.js", "Chart.min.js"]
    local_includes = ["modules/js/ColorfullBarChartModule.js"]
    ...
    def __init__(
        ...
        new_element = "new ColorfullBarChartModule({}, {}, {}, '{}', '{}')"
    ...
    def render(self, model):
        ...
        if self.scope == "agent":
            df = data_collector.get_agent_vars_dataframe()
