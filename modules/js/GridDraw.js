...
var GridVisualization = function(width, height, gridWidth, gridHeight, context, interactionHandler) {
        ...
        this.drawLayer = function(portrayalLayer) {
                ...
                for (var i in portrayalLayer) {
                        ...
                        if (p.Shape == "rect")
                                ...
                                this.drawArrowHead(p.x, p.y, p.rotate, p.scale, p.Color, p.stroke_color, p.Filled, p.text, p.text_color);
                        else
        ...
        */
        ...
        text_color: Color of the inscribed text.
        */
        this.drawArrowHead = function(x, y, rotation, scale, colors, stroke_color, fill, text, text_color) {
                ...
                new_point = rotate(cx,cy,p1_x,p1_y, rotation)
                p1_x = new_point[0];
                p1_y = new_point[1];

                new_point = rotate(cx,cy,p2_x,p2_y, rotation)
                p2_x = new_point[0];
                p2_y = new_point[1];

                new_point = rotate(cx,cy,p3_x,p3_y, rotation)
                p3_x = new_point[0];
                p3_y = new_point[1];

                new_point = rotate(cx,cy,p4_x,p4_y, rotation)
                p4_x = new_point[0];
                p4_y = new_point[1];
