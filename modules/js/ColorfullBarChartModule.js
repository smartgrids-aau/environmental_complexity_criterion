...
var ColorfullBarChartModule = function(fields, canvas_width, canvas_height, sorting, sortingKey) {
        ...
        rects
            ...
            .enter()
                .append("rect")
                    ...
                    .attr("y", function(d) { return Math.min(y(d.value['value']),y(0)); })
                    .attr("height", function(d) { return Math.abs(y(d.value['value']) - y(0)); })
                .append("title")
